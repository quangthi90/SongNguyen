...
$_['text_shipping']            = 'Địa chỉ chuyển hàng';
$_['text_payment']             = 'Địa chỉ thanh toán';
$_['text_mail']                = 'Mail';
$_['text_smtp']                = 'SMTP';

// Entry
$_['entry_product_count']          = 'Đếm sản phẩm trong danh mục:<br /><span class="help">Hiển thị số sản phẩm chứa trong danh mục ở danh sách danh mục sản phẩm ngoài cửa hàng. Cảnh báo: điều này sẽ gây ra một áp lực lớn cho các cửa hàng với rất nhiều thể loại!</span>';
$_['entry_review']       	       = 'Cho phép Nhận xét:<br /><span class="help">Bật / Tắt mục đánh giá mới và hiển thị các đánh giá hiện tại</span>';
$_['entry_download']               = 'Cho phép tải về:';
$_['entry_voucher_min']            = 'Số lượng phiếu quà tặng thấp nhất:<br /><span class="help">Số lượng thấp nhất một khách hàng có thể mua một phiếu quà tặng.</span>';
$_['entry_voucher_max']            = 'Số lượng phiếu quà tặng tối đa:<br /><span class="help">Số lượng tối đa một khách hàng có thể mua một phiếu quà tặng.</span>';
$_['entry_tax']                    = 'Display Prices With Tax:';
$_['entry_vat']                    = 'Xác nhận Số thuế GTGT:<br /><span class="help">Xác nhận số thuế GTGT với dịch vụ http://ec.europa.eu.</span>';
...
$_['entry_customer_online']        = 'Khách hàng trực tuyến:<br /><span class="help">Theo dõi khách hàng trực tuyến thông qua phần báo cáo của khách hàng.</span>';
$_['entry_customer_group']         = 'Customer Group:<br /><span class="help">Default customer group.</span>';
$_['entry_customer_group_display'] = 'Nhóm khách hàng:<br /><span class="help">Hiển thị các nhóm khách hàng mà khách hàng mới có thể chọn để sử dụng như bán buôn và kinh doanh khi đăng ký.</span>';
...
$_['entry_order_edit']             = 'Chỉnh sửa đơn đặt hàng:Order Editing:<br /><span class="help">Số ngày cho phép chỉnh sửa một đơn đặt hàng. Điều này cần thiết vì giá và các khoản giảm giá có thể thay đổi trong suốt thời gian làm hỏng đơn đặt hàng nếu nó đã được chỉnh sửa</span>';
...
$_['entry_complete_status']        = 'Trình trạng hoàn thành đơn đặt hàng:<br /><span class="help">Thiết lập tình trạng đơn hàng mà Khách hàng đặt hàng phải đạt được trước khi chúng đc cho phép để truy cập vào các sản phẩm tải về và phiếu quà tặng</span>';
...
$_['entry_return']                 = 'Điều khoản trả hàng:<br /><span class="help">Buộc mọi người đồng ý với các điều khoản trước khi một tài khoản trả về có thể được tạo ra.</span>';
...
$_['entry_shared']                 = 'Sử dụng chia sẻ phiên làm việc:<br /><span class="help">Hãy thử để chia sẻ cookie phiên làm việc giữa các cửa hàng để giỏ hàng có thể được thông qua giữa các tên miền khác nhau.</span>';
$_['entry_robots']                 = 'Robot:<br /><span class="help">Một danh sách các trang web đại lý người dùng thu thập các phiên chia sẻ sẽ không được sử dụng với. Sử dụng đường riêng biệt cho mỗi tác nhân người dùng.</span>';
...
$_['entry_file_extension_allowed'] = 'Cho phép các phần mở rộng tập tin:<br /><span class="help">Thêm các phần mở rộng tập tin được phép tải lên. Sử dụng một dòng mới cho mỗi giá trị.</span>';
$_['entry_file_mime_allowed']      = 'Cho phép File Types Mime:<br /><span class="help">Thêm tập tin đó loại mime được phép tải lên. Sử dụng một dòng mới cho mỗi giá trị.</span>';
$_['entry_password']               = 'Cho phép quên Mật khẩu:<br /><span class="help">Cho phép quên mật khẩu được sử dụng cho người quản trị. Điều này sẽ bị vô hiệu hóa tự động nếu hệ thống phát hiện một nổ lực tấn công.</span>';
$_['entry_google_analytics']       = 'Mã Google Analytics:<br /><span class="help">Đăng nhập vào tài khoản <a href="http://www.google.com/analytics/" target="_blank"><u>Google Analytics</u></a> của bạn và sau khi tạo trang web bản sao hồ sơ và dán mã phân tích vào lĩnh vực này của bạn.</span>';
...
$_['entry_tax_default']        = 'Sử dụng địa chỉ thuế của cửa hàng:<br /><span class="help">Sử dụng địa chỉ cửa hàng để tính thuế nếu không có ai được đăng nhập. Bạn có thể chọn để sử dụng địa chỉ cửa hàng cho các khách hàng vận chuyển hoặc địa chỉ thanh toán.</span>';
$_['entry_tax_customer']       = 'Sử dụng địa chỉ thuế của khách hàng:<br /><span class="help">Sử dụng địa chỉ mặc định của khách hàng khi họ đăng nhập để tính toán thuế. Bạn có thể chọn để sử dụng địa chỉ mặc định cho việc chuyển hàng hoặc địa chỉ thanh toán.</span>';
...
$_['entry_stock_warning']     = 'Cảnh báo hết hàng .:<br /><span class="help">Hiển thị ra thông điệp trên các trang giỏ mua hàng nếu một sản phẩm đã không còn trong kho nhưng thanh toán kho là có. (Cảnh báo luôn cho thấy thanh toán kho là không)</span>';
...
$_['entry_fraud_detection']     = 'Sử dụng hệ thống phát hiện gian lận MaxMind:<br /><span class="help">MaxMind là một dịch vụ phát hiện gian lận. Nếu bạn không có một key bản quyền bạn có thể <a onclick="window.open(\'http://www.maxmind.com/?rId=opencart\');"><u>đăng ký ở đây</u></a>. Một khi bạn đã có được một bản sao chìa khóa và dán nó vào trường bên dưới.</span>';
$_['entry_fraud_key']           = 'Khóa giấy phép sử dụng MaxMind:</span>';
$_['entry_fraud_score']         = 'Điểm số nguy hiểm MaxMind:<br /><span class="help">Điểm số cao hơn các likly hơn với thứ tự là gian lận. Thiết lập đánh số từ 0 - 100.</span>';
$_['entry_fraud_status']        = 'MaxMind Tình trạng đặt hàng gian lận:<br /><span class="help">Đơn đặt hàng trên số điểm thiết lập của bạn sẽ được chỉ định để tình trạng này và sẽ không được cho phép đạt tới trạng thái hoàn toàn tự động.</span>';
$_['entry_secure']               = 'Dùng SSL:<br /><span class="help">Để sử dụng kiểm tra SSL với máy chủ của bạn nếu một chứng chỉ SSL được cài đặt và thêm vào các URL SSL cho người quản trị tập tin cấu hình.</span>';
