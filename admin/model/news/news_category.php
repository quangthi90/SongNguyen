...
class ModelNewsNewsCategory extends Model {
	public function addNewsCategory($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "news_category SET parent_id = '" . (int)$data['parent_id'] . "', sort_order = '" . (int)$data['sort_order'] . "', status = '" . (int)$data['status'] . "', have_popup = '" . (int)$data['have_popup'] . "', link = '" . $this->db->escape($data['link']) . "', date_modified = NOW(), date_added = NOW()");
	...
	public function editNewsCategory($news_category_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "news_category SET parent_id = '" . (int)$data['parent_id'] . "', sort_order = '" . (int)$data['sort_order'] . "', status = '" . (int)$data['status'] . "', have_popup = '" . (int)$data['have_popup'] . "', link = '" . $this->db->escape($data['link']) . "', date_modified = NOW() WHERE id = '" . (int)$news_category_id . "'");
