...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="view/image/program.png" alt="" /> <?php echo $heading_title; ?></h1>
      ...
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($program['selected']) { ?>
                ...
                <?php } ?></td>
              <td class="center"><img src="<?php echo $program['image']; ?>" alt="<?php echo $program['title']; ?>" style="padding: 1px; border: 1px solid #DDDDDD;" /></td>
              <td class="left"><?php echo $program['title']; ?></td>
              <td class="left"><?php echo $program['status']; ?></td>
              <td class="right"><?php foreach ($program['action'] as $action) { ?>
...
function filter() {
	url = 'index.php?route=program/program&token=<?php echo $token; ?>';
...
$('input[name=\'filter_title\']').autocomplete({
	...
	source: function(request, response) {
		$.ajax({
			url: 'index.php?route=program/program/autocomplete&token=<?php echo $token; ?>&filter_title=' +  encodeURIComponent(request.term),
			dataType: 'json',
