          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              <tr>
                ...
                <td><input type="text" name="faq_category_description[<?php echo $language['language_id']; ?>][name]" size="100" value="<?php echo isset($faq_category_description[$language['language_id']]) ? $faq_category_description[$language['language_id']]['name'] : ''; ?>" />
